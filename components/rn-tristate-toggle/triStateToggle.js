...
//       }else {
//         this.setState({
//           circleXPos: new Animated.Value(0),
//           yesOptionXPos: new Animated.Value(0),
//           noOptionOpacity: new Animated.Value(0),
//           yesOptionOpacity: new Animated.Value(1),
//           selected: SELECTED_NONE
...
//               ...{
//                 transform:[{translateX :this.state.noOptionXPos}],
...
//           <Animated.View
//             style={{ ...circleStyle, ...{ transform:[ {translateX:this.state.circleXPos}]  } }}
//           />
...
//               ...{ flex: 1, alignItems: 'center' },
//               ...{
//                 transform:[{translateX: this.state.yesOptionXPos}],
